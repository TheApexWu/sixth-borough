...
Overworld (Map = Lobby) — top-down isometric, washed cool palette, hazy distance, tiny cursor exploring monumental emptiness. This is where 95% of user time is spent.
Encounter (Ghost = Dungeon) — character-scale dive, saturated accent against muted base, surreal architectural scale, fixed camera framing. This is the 30-60 second moment when a user clicks a ghost.
The two modes never blur. The map is the lobby. The ghost is the dungeon. Don't merge them.

Mode A
Overworld — the social map
...
Reference 01 — Shibuya from above. Top-down isometric, district as diorama in a void, tiny figure dwarfed by architecture.
Reference 01 — Shibuya from above. Top-down isometric, district as diorama in a void, tiny figure dwarfed by architecture.
What to extract
...
Reference 02 — Ariake monumental emptiness. Scattered debris, pale brown-grey foreground transitioning to icy blue distance.
Reference 02 — Ariake monumental emptiness. Scattered debris, pale brown-grey foreground transitioning to icy blue distance.
What to extract
...
Reference 03 — Daiba bridge infrastructure. Iconic suspension bridge silhouette readable at low poly.
Reference 03 — Daiba bridge infrastructure. Iconic suspension bridge silhouette readable at low poly.
What to extract
...
Reference 04 — Ginza with vortex rings. The single best overworld reference: concentric ground rings + low-poly pylons mark memory anchors.
Reference 04 — Ginza with vortex rings. The single best overworld reference: concentric ground rings + low-poly pylons mark memory anchors.
What to extract (best overworld reference for our use case)
Concentric circular ground patterns radiating from a focal point. In SMT3 these are Magatsuhi vortices. In Sixth Borough they become memory anchors — concentric rings on the ground around a ghost spawn point indicate "something happened here."
Conical pylons / spikes scattered around the rings as markers. Use as ghost-spawn indicators — small, low-poly, immediately recognizable as "interactive."
...
Reference 05 — Demi-fiend keyart. Saturated teal accent against muted sepia, iconic landmark anchoring the scene, floating debris orbiting a sun.
Reference 05 — Demi-fiend keyart. Saturated teal accent against muted sepia, iconic landmark anchoring the scene, floating debris orbiting a sun.
What to extract
...
Reference 06 — Labyrinth of Amala. Massive floating geometric monoliths, tiny character against towering architecture, vertex lighting.
Reference 06 — Labyrinth of Amala. Massive floating geometric monoliths, tiny character against towering architecture, vertex lighting.
What to extract
Massive floating geometric monoliths in vast empty space. Character is small, architecture is enormous. Sixth Borough's encounter dimension should follow the same scale ratio.
...
Sixth Borough — Spark Hack NYC, April 11 2026. Visual reference images are screenshots from Shin Megami Tensei III: Nocturne (Atlus, 2003) and HD Remaster (Atlus, 2020/2021), used as a fair-use mood board for internal team alignment. All rights to Atlus / Sega.